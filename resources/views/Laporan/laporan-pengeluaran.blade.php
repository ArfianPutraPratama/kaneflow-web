...
<head>
    ...
    <title>SB Admin 2 - Laporan Pengeluaran</title>
    ...
    <style>
        ...
        .btn-primary:focus {
            ...
            /* Match hover color when clicked/active, override default blue */
            outline: none;
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h4 mb-4 text-gray-800"><i class="fas fa-file-import fa-fw mr-2"></i>Laporan Pengeluaran
                    </h1>
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="kategori" class="form-control">
                                                <option value=""
                                                    ...
                                                    Semua --</option>
                                                <option value="1"
                                                    {{ isset($kategori) && $kategori == '1' ? 'selected' : '' }}>
                                                    Belanja Harian</option>
                                                <option value="2"
                                                    {{ isset($kategori) && $kategori == '2' ? 'selected' : '' }}>
                                                    Tagihan Listrik</option>
                                                <option value="3"
                                                    {{ isset($kategori) && $kategori == '3' ? 'selected' : '' }}>
                                                    Tagihan Air</option>
                                                <option value="4"
                                                    {{ isset($kategori) && $kategori == '4' ? 'selected' : '' }}>Biaya
                                                    Transportasi</option>
                                                <option value="5"
                                                    {{ isset($kategori) && $kategori == '5' ? 'selected' : '' }}>Biaya
                                                    Pendidikan</option>
                                                <option value="6"
                                                    {{ isset($kategori) && $kategori == '6' ? 'selected' : '' }}>Biaya
                                                    Kesehatan</option>
                                                <option value="7"
                                                    {{ isset($kategori) && $kategori == '7' ? 'selected' : '' }}>
                                                    Pengeluaran Hiburan</option>
                                                <option value="8"
                                                    {{ isset($kategori) && $kategori == '8' ? 'selected' : '' }}>
                                                    Pengeluaran Donasi</option>
                                                <option value="9"
                                                    {{ isset($kategori) && $kategori == '9' ? 'selected' : '' }}>
                                                    Pengeluaran Investasi</option>
                                                <option value="10"
                            ...
                            @if (request()->isMethod('post'))
                                ...
                                @if (empty($bulan) && empty($kategori) && !empty($tahun))
                                    ...
                                    <div class="card mt-4">
                                        <div class="card-header py-3 d-flex justify-content-between align-items-center">
                                            <h6 class="m-0 font-weight-bold text-primary">Laporan Pengeluaran Tahun
                                                {{ $tahunDisplay }}</h6>
                                            <button class="btn btn-warning" onclick="window.print()">Cetak</button>
                                        </div>
                                        <div class="card-body">
                                            <table class="table table-bordered report-table" id="dataTableSummary">
                                                    ...
                                                    @else
                                                        <tr>
                                                            <td colspan="4" class="text-center">Tidak ada data
                                                                pengeluaran untuk tahun ini.</td>
                                                        </tr>
                                                    @endif
                                                </tbody>
                                                <tfoot>
                                ...
                                @elseif (!empty($bulan) && empty($tahun) && empty($kategori))
                                    ...
                                    @php
                                        // Fetch pengeluaranData from session with user-specific key
                                        $pengeluaranData = session('pengeluaranData_' . Auth::id(), []);
                                        $filteredData = [];
                                        $totalPengeluaranDetail = 0;
                                        ...
                                        foreach ($pengeluaranData as $item) {
                                            ...
                                            if ($itemMonth == $bulan) {
                                                $filteredData[] = $item;
                                                $totalPengeluaranDetail += $item['jumlah'];
                                            }
                                        }
                                    @endphp
                                    ...
                                    <ul class="nav nav-tabs mt-4" id="reportTabs" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="laporan-tab" data-toggle="tab"
                                                ...
                                                aria-selected="true">Laporan Pengeluaran</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content" id="reportTabsContent">
                                        <!-- Laporan Pengeluaran Tab (Summary) -->
                                            ...
                                            <div class="card mt-2">
                                                <div
                                                    ...
                                                    <h6 class="m-0 font-weight-bold text-primary">
                                                        Laporan Pengeluaran Bulan {{ $bulanDisplay }}, Tahun Semua,
                                                        ...
                                                        <tbody>
                                                            @if (count($filteredData) > 0)
                                                                <tr>
                                                                    ...
                                                                    <td>Rp.
                                                                        {{ number_format($totalPengeluaranDetail, 0, ',', '.') }}
                                                                    </td>
                                                                </tr>
                                                            @else
                                                                <tr>
                                        ...
                                        <!-- Detail Laporan Pengeluaran Tab -->
                                        <div class="tab-pane fade" id="detail" role="tabpanel"
                                            ...
                                            <div class="card mt-2">
                                                <div
                                                    class="card-header py-3 d-flex justify-content-between align-items-center">
                                                    <h6 class="m-0 font-weight-bold text-primary">
                                                        Detail Laporan Pengeluaran Bulan {{ $bulanDisplay }}, Tahun
                                        ...
                                        <div class="tab-pane fade show active" id="laporan" role="tabpanel"
                                            ...
                                            <div class="card mt-2">
                                                <div
                                                    class="card-header py-3 d-flex justify-content-between align-items-center">
                                                    <h6 class="m-0 font-weight-bold text-primary">
                                                        Laporan Pengeluaran Bulan {{ $bulanDisplay }} Tahun
                                ...
                                @elseif (!empty($bulan) && !empty($tahun) && !empty($kategori))
                                    ...
                                    @php
                                        ...
                                        foreach ($pengeluaranData as $item) {
                                            ...
                                            // Match category using kategoriText mapping
