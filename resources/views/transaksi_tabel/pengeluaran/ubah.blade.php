            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h4 mb-sm-0 text-gray-800"><i class="fas fa-sign-in-alt fa-fw mr-2"></i>Pengeluaran
                        </h1>
                        <a href="{{ route('pengeluaran.tabel') }}" class="btn btn-kembali btn-sm">
                    ...
                    <div class="notification" id="successNotification">
                        ...
                        <span id="notificationMessage">Sukses! Data pengeluaran berhasil diperbarui.</span>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form id="updatePengeluaranForm"
                                action="{{ route('pengeluaran.update', $pengeluaran->id) }}" method="POST"
                                ...
                                <div class="form-group col-lg-6 pl-0">
                                    ...
                                    <div class="date-picker-container input-group">
                                        <input type="text" name="tanggal" class="form-control date-picker"
                                            ...
                                            value="{{ \Carbon\Carbon::parse($pengeluaran->tanggal)->format('d-m-Y') }}"
                                            required>
                                    ...
                                    <div class="custom-dropdown" id="dropdownContainer">
                                        <div class="dropdown-header" id="dropdownHeader">
                                            <input type="text" class="dropdown-input" id="dropdownInput"
                                                value="{{ $pengeluaran->kategori }}" placeholder="-- Pilih --" readonly>
                                            <input type="hidden" id="selectedValue" name="kategori"
                                                value="{{ $pengeluaran->kategori_id }}">
                                        ...
                                        <div class="dropdown-options" id="dropdownOptions">
                                            ...
                                            <ul class="options-list" id="optionsList">
                                                ...
                                                <li class="option-item {{ $pengeluaran->kategori_id == 1 ? 'selected' : '' }}"
                                                    data-value="1">Belanja Harian</li>
                                                <li class="option-item {{ $pengeluaran->kategori_id == 2 ? 'selected' : '' }}"
                                                    data-value="2">Tagihan Listrik</li>
                                                <li class="option-item {{ $pengeluaran->kategori_id == 3 ? 'selected' : '' }}"
                                                    data-value="3">Tagihan Air</li>
                                                <li class="option-item {{ $pengeluaran->kategori_id == 4 ? 'selected' : '' }}"
                                                    data-value="4">Biaya Transportasi</li>
                                                <li class="option-item {{ $pengeluaran->kategori_id == 5 ? 'selected' : '' }}"
                                                    data-value="5">Biaya Pendidikan</li>
                                                <li class="option-item {{ $pengeluaran->kategori_id == 6 ? 'selected' : '' }}"
                                                    data-value="6">Biaya Kesehatan</li>
                                                <li class="option-item {{ $pengeluaran->kategori_id == 7 ? 'selected' : '' }}"
                                                    data-value="7">Pengeluaran Hiburan</li>
                                                <li class="option-item {{ $pengeluaran->kategori_id == 8 ? 'selected' : '' }}"
                                                    data-value="8">Pengeluaran Donasi</li>
                                                <li class="option-item {{ $pengeluaran->kategori_id == 9 ? 'selected' : '' }}"
                                                    data-value="9">Pengeluaran Investasi</li>
                                                <li class="option-item {{ $pengeluaran->kategori_id == 10 ? 'selected' : '' }}"
                                                    data-value="10">Pengeluaran Lainnya</li>
                                            </ul>
                                        </div>
                                ...
                                <div class="form-group col-lg-6 pl-0">
                                    ...
                                    <textarea name="deskripsi" rows="3" class="form-control" autocomplete="off" required>{{ $pengeluaran->deskripsi }}</textarea>
                                ...
                                <div class="form-group col-lg-6 pl-0">
                                    <label>Jumlah <ansky class="text-danger">*</span></label>
                                    <div class="input-group">
                                        ...
                                        <div class="invalid-feedback">Jumlah pengeluaran tidak boleh kosong atau
                                            tidak
                                            valid.</div>
                                        @error('jumlah')
                                            <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="form-group col-lg-6 pt-3 pl-0">
                                    ...
                                    <div class="col-lg-6 border rounded my-4">
                                        <img id="preview-file"
                                            src="{{ $pengeluaran->bukti_transaksi ? asset('storage/' . $pengeluaran->bukti_transaksi) : asset('images/no_image.png') }}"
                                            class="col foto-preview py-3" alt="Bukti Transaksi"
                                            style="{{ $pengeluaran->bukti_transaksi ? '' : 'display: none;' }}">
                                    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            showNotification('Sukses! Data pengeluaran berhasil diperbarui.');
                            sessionStorage.setItem('updatedPengeluaran', JSON.stringify(response
                                .data));
                        } else {
            ...
            buktiTransaksiInput.addEventListener('change', function(e) {
                ...
                if (file) {
                    ...
                    previewFile.src =
                        '{{ $pengeluaran->bukti_transaksi ? asset('storage/' . $pengeluaran->bukti_transaksi) : asset('images/no_image.png') }}';
                    previewFile.style.display = '{{ $pengeluaran->bukti_transaksi ? 'block' : 'none' }}';
                }
            });
